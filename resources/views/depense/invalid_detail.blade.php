        ...
        <div class="col-md-12">
            <div class="card">
                <div class="text-center">
                    <h2>Dépense : {{$depense->description}}</h2>
                  </div>
                <div class="  card-body ">
                    <div class="row">
                        <div class="col-7">
                        ...
                        <div class="col-5 ">
                            <div class="list-group mt-1">  
                                <div class="list-item text-bold row"><span class="font-weight-bold col-6" >Statut : </span><span > @switch($depense->statut)
                                ...
                                <div class="form-group d-flex float-right col-auto">
                                    @can('manage-users')
                                    <a class="btn btn-success"  href="{{route('depense.validate', $depense->id)}}"> Valider</a>
                                    <a class="btn btn-danger ml-2"  href="{{route('depense.rejet', $depense->id)}}">Rejeter</a>
                                    @endcan
